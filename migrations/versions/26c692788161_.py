...
Revision ID: 26c692788161
Revises: 
Create Date: 2025-02-03 14:19:58.178110
...
def upgrade():
    ...
    sa.Column('lust_update_by_id', sa.Integer(), nullable=True),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('sms_confirmation_code', sa.String(), nullable=True),
    sa.Column('phone_confirmed', sa.Boolean(), nullable=True),
    sa.Column('confirmed_by_client', sa.Boolean(), nullable=True),
    sa.Column('canceled_by_client', sa.Boolean(), nullable=True),
